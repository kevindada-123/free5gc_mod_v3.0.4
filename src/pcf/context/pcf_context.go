...
// 20210618 added from /src/pcf/util/init_context.go
...
func InitpcfContext() {
	...
	ManagementConfig.SetBasePath(PCF_Self().NrfUri)
	pcfContext.NFManagementClient = Nnrf_NFManagement.NewAPIClient(ManagementConfig)
