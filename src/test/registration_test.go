...
func TestRegistration(t *testing.T) {
	...
	ue := test.NewRanUeContext("imsi-2089300027400", 1, security.AlgCiphering128NEA0, security.AlgIntegrity128NIA2)
	ue.AmfUeNgapId = 1
	...
	mobileIdentity5GS := nasType.MobileIdentity5GS{
		Len:    12, // suci
		Buffer: []uint8{0x01, 0x02, 0xf8, 0x39, 0xf0, 0xff, 0x00, 0x00, 0x00, 0x20, 0x47, 0x00},
	}
...
func TestMultiRegistration(t *testing.T) {
	...
	for i := 0; i < UEnumber; i++ {
		...
		// ue := test.NewRanUeContext("imsi-2089300007487", 1, security.AlgCiphering128NEA2, security.AlgIntegrity128NIA2)
		//supi := test.NextSupi()
		supiprefix := "imsi-208930001"
		supi := supiprefix + strconv.Itoa(7400+i)
		...
		var supisuffix uint8
		tempstring := (i / 10) + 16*(i%10)
		supisuffix = uint8(tempstring)
		mobileIdentity5GS := nasType.MobileIdentity5GS{
			Len:    12, // suci
			Buffer: []uint8{0x01, 0x02, 0xf8, 0x39, 0xf0, 0xff, 0x00, 0x00, 0x00, 0x10, 0x47, supisuffix},
		}
		// send InitialUeMessage(Registration Request)(imsi-2089300017400)
		//mobileIdentity5GS := nasType.MobileIdentity5GS{
		//	Len:    12, // suci
