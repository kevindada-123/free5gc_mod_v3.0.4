...
// APIClient manages communication with the Nsmaf_PDUSession API v1.0.0
...
type APIClient struct {
	...
	// API Services
	IndividualPDUSessionHSMAFApi       *IndividualPDUSessionHSMAFApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.IndividualPDUSessionHSMAFApi = (*IndividualPDUSessionHSMAFApiService)(&c.common)
