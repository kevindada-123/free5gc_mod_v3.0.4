 ...
 * SMAF API
 *
 * OpenAPI specification for SMAF
 *
 * API version: 1.0.0
...
func (a *DefaultApiService) UeAuthenticationsForward(ctx context.Context, authenticationInfo models.AuthenticationInfo) (models.UeAuthenticationCtx, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath() + "/test-forward"
